      ...
      <header className="fixed top-0 inset-x-0 z-50 pointer-events-none flex justify-center px-3 sm:px-6 pt-4 sm:pt-5 transition-all duration-300">
        <motion.div
          ...
          className={cn(
            ...
            isScrolled
              ? "w-auto max-w-fit mx-auto bg-[#02040A]/95 border border-[#F59E0B]/20 backdrop-blur-2xl py-1.5 px-3 sm:px-4 rounded-full shadow-2xl shadow-black/85 gap-2 sm:gap-3"
              : "w-full max-w-7xl mx-auto bg-[#02040A]/85 border border-[#F59E0B]/15 backdrop-blur-xl py-2.5 sm:py-3 px-4 sm:px-6 rounded-2xl sm:rounded-full shadow-lg shadow-black/40 gap-4"
          )}
        >
          {/* ========================================================= */}
          {/* Brand Logo                                                */}
          ...
          <Link
            href="/"
            className="flex items-center gap-2.5 shrink-0 group focus:outline-none focus-visible:ring-2 focus-visible:ring-[#F59E0B] rounded-lg"
          >
            <div
              className={cn(
                "rounded-xl bg-gradient-to-br from-[#F59E0B] to-[#EA580C] p-0.5 shadow-md shadow-[#F59E0B]/25 group-hover:shadow-[#EA580C]/35 transition-all duration-300",
            ...
            >
              <div className="w-full h-full bg-[#02040A] rounded-[10px] flex items-center justify-center">
                <Terminal
                  className={cn(
                    "text-[#F59E0B] group-hover:text-white transition-colors duration-200",
            ...
            <div className="flex flex-col">
              <span
                className={cn(
                  "font-heading font-extrabold tracking-tight text-white group-hover:text-[#F59E0B] transition-colors",
                  isScrolled
              ...
              {!isScrolled && (
                <span className="text-[9px] sm:text-[10px] font-mono uppercase tracking-widest text-[#94A3B8] -mt-1 hidden sm:inline">
                  Class HQ
                </span>
              )}
            </div>
              ...
              return (
                ...
                >
                  ...
                  {isActive && (
                    ...
                    >
                      <div className="absolute inset-0 bg-[#EA580C]/30 rounded-full blur-sm" />
                      <div className="absolute inset-[-4px] bg-[#F59E0B]/25 rounded-full blur-md" />
                      <div
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="md:hidden p-1.5 rounded-lg bg-white/[0.05] border border-white/[0.1] text-[#F8FAFC] hover:bg-white/[0.1] focus:outline-none focus:ring-2 focus:ring-[#F59E0B]"
            >
        ...
        {mobileOpen && (
          <div className="fixed inset-0 z-40 md:hidden">
            ...
            <motion.div
              ...
              className="fixed top-20 inset-x-4 z-50 md:hidden rounded-2xl border border-[#F59E0B]/20 bg-[#02040A]/95 backdrop-blur-2xl p-4 shadow-2xl space-y-3 max-w-sm mx-auto"
            >
                  ...
                  return (
                    <Link
                      ...
                      className={cn(
                        ...
                        isActive
                          ? "bg-gradient-to-r from-[#F59E0B] to-[#EA580C] text-[#02040A] font-bold shadow-sm"
